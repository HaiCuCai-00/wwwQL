...
namespace BSAF16072021.Areas.admin.Controllers
{
    public class TrainingsController : BaseController
    {
        ...
        public ActionResult Create([Bind(Include = "training_id,training_name,training_password,training_email,training_telephone,training_address,dadelete")] Training training)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "training_id,training_name,training_password,training_email,training_telephone,training_address,dadelete")] Training training)
        {
            if (ModelState.IsValid)
            {
